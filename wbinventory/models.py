...
class Item(models.Model):
    ...
    reorder_quantity = quantity_field(null=True, default=None)
    target_quantity = quantity_field(null=True, default=None)
...
class Location(models.Model):
    ...
    third_party = models.ForeignKey(THIRD_PARTY_MODEL, null=True)
