...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('wbinventory_item', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.notes'
        db.delete_column('wbinventory_item', 'notes')
