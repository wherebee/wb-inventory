...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ItemUnitOfMeasureConversion'
        db.create_table('wbinventory_itemunitofmeasureconversion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wbinventory.Item'])),
            ('from_quantity', self.gf('django.db.models.fields.DecimalField')(default='1', max_digits=16, decimal_places=6)),
            ('from_uom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['wbinventory.UnitOfMeasure'])),
            ('to_quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=16, decimal_places=6)),
            ('to_uom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['wbinventory.UnitOfMeasure'])),
        ))
        db.send_create_signal('wbinventory', ['ItemUnitOfMeasureConversion'])

        # Adding unique constraint on 'ItemUnitOfMeasureConversion', fields ['from_quantity', 'from_uom']
        db.create_unique('wbinventory_itemunitofmeasureconversion', ['from_quantity', 'from_uom_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ItemUnitOfMeasureConversion', fields ['from_quantity', 'from_uom']
        db.delete_unique('wbinventory_itemunitofmeasureconversion', ['from_quantity', 'from_uom_id'])

        # Deleting model 'ItemUnitOfMeasureConversion'
        db.delete_table('wbinventory_itemunitofmeasureconversion')
