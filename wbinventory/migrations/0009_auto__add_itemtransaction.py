...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ItemTransaction'
        db.create_table('wbinventory_itemtransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wbinventory.Item'])),
            ('from_location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wbinventory.Location'])),
            ('from_quantity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=6, blank=True)),
            ('from_uom', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wbinventory.UnitOfMeasure'])),
            ('to_location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wbinventory.Location'])),
            ('to_quantity', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=6, blank=True)),
            ('to_uom', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wbinventory.UnitOfMeasure'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('wbinventory', ['ItemTransaction'])


    def backwards(self, orm):
        
        # Deleting model 'ItemTransaction'
        db.delete_table('wbinventory_itemtransaction')
