...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemSupplier.number'
        db.add_column('wbinventory_itemsupplier', 'number', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding unique constraint on 'ItemSupplier', fields ['item', 'number', 'third_party']
        db.create_unique('wbinventory_itemsupplier', ['item_id', 'number', 'third_party_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ItemSupplier', fields ['item', 'number', 'third_party']
        db.delete_unique('wbinventory_itemsupplier', ['item_id', 'number', 'third_party_id'])

        # Deleting field 'ItemSupplier.number'
        db.delete_column('wbinventory_itemsupplier', 'number')
