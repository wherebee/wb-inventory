...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.default_uom'
        db.alter_column('wbinventory_item', 'default_uom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wbinventory.UnitOfMeasure'], null=True))

        # Changing field 'Item.default_location'
        db.alter_column('wbinventory_item', 'default_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wbinventory.Location'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Item.default_uom'
        raise RuntimeError("Cannot reverse this migration. 'Item.default_uom' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Item.default_location'
        raise RuntimeError("Cannot reverse this migration. 'Item.default_location' and its values cannot be restored.")
